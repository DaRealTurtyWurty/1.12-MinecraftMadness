...
public class SoundsHandler 
{
	...
	public static SoundEvent ITEM_ARMOR_EQUIP_MAGMATIC;
	...
	public static void registerSounds()
	{
		...
		BOOK_CLOSE = registerSound("book.close");
		PAGE_FLIP = registerSound("book.page_flip");
		
		ITEM_ARMOR_EQUIP_MAGMATIC = registerSound("armor.magmatic");
	}
