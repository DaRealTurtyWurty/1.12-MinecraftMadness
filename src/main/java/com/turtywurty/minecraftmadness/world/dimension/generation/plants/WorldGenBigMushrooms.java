...
public class WorldGenBigMushrooms extends WorldGenAbstractTree
{
    /** The mushroom type. 0 for brown, 1 for red. */
    private final Block mushroomType;

    public WorldGenBigMushrooms(Block p_i46449_1_)
    {
        super(true);
        this.mushroomType = p_i46449_1_;
    }

    public WorldGenBigMushrooms()
    {
        super(false);
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position)
    {
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 < 256)
        {
            ...
            else
            {
                ...
                if (block1 != BlockInit.MUTATED_GRASS)
                {
                    return false;
                }
                else
