...
import com.turtywurty.minecraftmadness.objects.blocks.world.dimension.MutatedSapling;
...
{
	public static final IBlockState LOG = BlockInit.MUTATED_LOG.getDefaultState();
	public static final IBlockState LEAF = BlockInit.MUTATED_LEAVES.getDefaultState();
	
	private final int minHeight;
	
	public WorldGenMutatedTree() 
	{
		super(false);
		this.minHeight = 12;
	}
	...
	public boolean generate(World world, Random rand, BlockPos pos) 
	{
		...
		else
		{
			...
			boolean isSoil = state.getBlock().canSustainPlant(state, world, down, EnumFacing.UP, (MutatedSapling)BlockInit.MUTATED_SAPLING);
	...
	protected boolean canGrowInto(Block blockType)
	{
        ...
        return material == Material.AIR || material == Material.LEAVES || blockType == BlockInit.MUTATED_DIRT || blockType == BlockInit.MUTATED_GRASS || blockType == BlockInit.MUTATED_SAPLING;
