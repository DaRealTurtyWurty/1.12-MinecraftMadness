...
public class EntityInit 
{
	public static void registerEntities()
	{
		...
		registerEntity("beaver", EntityBeaver.class, Reference.ENTITY_BEAVER, 30, 9980708, 13078895);
		registerNonMobEntity("fire_arrow", EntityFireArrow.class, Reference.ENTITY_FIRE_ARROW);
	}
	...
	private static void registerNonMobEntity(String name, Class<? extends Entity> entity, int id)
	{
		EntityRegistry.registerModEntity(new ResourceLocation(Reference.MOD_ID + ":" + name), entity, name, id, MinecraftMadness.instance, 64, 20, true);
	}
}