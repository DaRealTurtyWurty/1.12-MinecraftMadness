...
public class ArmchairSeat 
{
    ...
    public static void onInteractWithBlock(PlayerInteractEvent.RightClickBlock event) 
    {
        ...
        if (state.getBlock() instanceof Armchair) 
        {
    ...
    public static class SeatStair extends Entity 
    {
        ...
        public SeatStair(World world, BlockPos pos) 
        {
            ...
            setPosition(pos.getX() + 0.5, pos.getY() + 0.2, pos.getZ() + 0.5);
        }
        ...
        public void onUpdate() 
        {
            ...
            if (!(getEntityWorld().getBlockState(pos).getBlock() instanceof Armchair)) 
            {
                setDead();
                return;
            }
