...
public class ItemEnchantedRubyApple extends ItemFood implements IHasModel
{
	public ItemEnchantedRubyApple(int amount, float saturation, boolean isWolfFood, String name) 
	{
