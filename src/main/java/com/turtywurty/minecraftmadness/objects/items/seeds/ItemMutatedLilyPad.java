...
public class ItemMutatedLilyPad extends Item implements IHasModel
{
	public ItemMutatedLilyPad(String name) 
	{
        ...
        else
        {
            if (raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK)
            {
                ...
                if (iblockstate.getMaterial() == Material.WATER && ((Integer)iblockstate.getValue(BlockLiquid.LEVEL)).intValue() == 0 && worldIn.isAirBlock(blockpos1))
                {
                    ...
                    worldIn.setBlockState(blockpos1, BlockInit.MUTATED_LILYPAD.getDefaultState());
                    ...
                    worldIn.setBlockState(blockpos1, BlockInit.MUTATED_LILYPAD.getDefaultState(), 11);
