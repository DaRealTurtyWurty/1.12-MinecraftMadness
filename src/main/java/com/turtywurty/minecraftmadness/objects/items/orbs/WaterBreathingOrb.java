...
import com.turtywurty.minecraftmadness.entity.orbs.EntityWaterBreathingOrb;
...
public class WaterBreathingOrb extends Item implements IHasModel
{
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer player, EnumHand handIn) 
	{
        ...
        {
            EntityWaterBreathingOrb entitywaterbreathingorb = new EntityWaterBreathingOrb(worldIn, player);
            entitywaterbreathingorb.shoot(player, player.rotationPitch, player.rotationYaw, 0.0F, 1.5F, 1.0F);
            worldIn.spawnEntity(entitywaterbreathingorb);
