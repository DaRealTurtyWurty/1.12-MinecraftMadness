...
public class TileEntityQuarryBasic extends TileEntity implements ITickable 
{
	...
	private void execute() 
	{
		...
		for (Block block : blocksRemoved) 
		{
			if (!world.isRemote)
			{
				...
				{
					InventoryHelper.spawnItemStack(this.world, this.x + 1, this.pos.getY(), this.z + 1, new ItemStack(Items.BOOK));
				}
				...
				{
					InventoryHelper.spawnItemStack(this.world, this.x + 1, this.pos.getY(), this.z + 1, new ItemStack(Items.BEETROOT));
				}
				if(block == Blocks.CARROTS)
				{
					InventoryHelper.spawnItemStack(this.world, this.x + 1, this.pos.getY(), this.z + 1, new ItemStack(Items.CARROT));
				}	
				if(block == Blocks.CHORUS_PLANT)
				{
					InventoryHelper.spawnItemStack(this.world, this.x + 1, this.pos.getY(), this.z + 1, new ItemStack(Items.CHORUS_FRUIT));
				}
				if(block == Blocks.COCOA)
				{
					InventoryHelper.spawnItemStack(this.world, this.x + 1, this.pos.getY(), this.z + 1, new ItemStack(Items.DYE, 1, 3));
				}
				...
				{
					InventoryHelper.spawnItemStack(this.world, this.x + 1, this.pos.getY(), this.z + 1, new ItemStack(Blocks.DIRT));
				}
				...
				{
					InventoryHelper.spawnItemStack(this.world, this.x + 1, this.pos.getY(), this.z + 1, new ItemStack(Blocks.FURNACE));
				}	
				if(block == Blocks.LIT_REDSTONE_ORE)
				{
					InventoryHelper.spawnItemStack(this.world, this.x + 1, this.pos.getY(), this.z + 1, new ItemStack(Items.REDSTONE));
				}
				if(block == Blocks.MELON_STEM)
				{
					InventoryHelper.spawnItemStack(this.world, this.x + 1, this.pos.getY(), this.z + 1, new ItemStack(Items.MELON_SEEDS));
				}
				...
				{
					InventoryHelper.spawnItemStack(this.world, this.x + 1, this.pos.getY(), this.z + 1, new ItemStack(Items.NETHER_WART));
				}
				...
				if(block == Blocks.WEB)
				{
					InventoryHelper.spawnItemStack(this.world, this.x + 1, this.pos.getY(), this.z + 1, new ItemStack(Items.STRING));
				}
				...
				if(block == Blocks.DEADBUSH)
				{
					InventoryHelper.spawnItemStack(this.world, this.x + 1, this.pos.getY(), this.z + 1, new ItemStack(Items.STICK));
				}
