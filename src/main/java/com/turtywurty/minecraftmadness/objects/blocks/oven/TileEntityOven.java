...
public class TileEntityOven extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    public void readFromNBT(NBTTagCompound compound)
    {
        ...
        this.currentItemBurnTime = getItemBurnTime(this.ovenItemStacks.get(1));
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            if (this.isBurning() || !itemstack.isEmpty() && !((ItemStack)this.ovenItemStacks.get(0)).isEmpty())
            {
                ...
                {
                    this.ovenBurnTime = getItemBurnTime(itemstack);
            ...
            {
                flag1 = true;
                OvenBlock.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = OvenRecipes.instance().getCookingResult(this.ovenItemStacks.get(0));
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack)
    {
        ...
        {
            ItemStack itemstack = this.ovenItemStacks.get(1);
            return isItemFuel(stack) || SlotOvenFuel.isBucket(stack) && itemstack.getItem() != Items.BUCKET;
        }
    }
