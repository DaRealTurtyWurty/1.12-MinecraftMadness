...
{
	private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":textures/gui/blender.png");
	private final InventoryPlayer player;
	private final TileEntityBlender tileentity;
	
	public GuiBlender(InventoryPlayer player, TileEntityBlender tileentity) 
	{
		super(new ContainerBlender(player, tileentity));
		this.player = player;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		if(TileEntityBlender.isBlending(tileentity))
		{
