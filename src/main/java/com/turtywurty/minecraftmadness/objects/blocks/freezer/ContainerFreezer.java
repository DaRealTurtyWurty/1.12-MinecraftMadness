...
public class ContainerFreezer extends Container
{
	...
	private final TileEntityFreezer chestInventory;
	
	public ContainerFreezer(InventoryPlayer playerInv, TileEntityFreezer chestInventory, EntityPlayer player) 
	{
	...
	public TileEntityFreezer getChestInventory()
	{
