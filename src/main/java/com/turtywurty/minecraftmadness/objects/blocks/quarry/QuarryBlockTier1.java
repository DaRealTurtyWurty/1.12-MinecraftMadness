...
public class QuarryBlockTier1 extends Block implements IHasModel, ITileEntityProvider 
{
	public QuarryBlockTier1(String name, Material material)
	{
		super(material);
	...
	{
		return new TileEntityQuarryTier1();
	}
