...
public class PlateBlock extends Block implements IHasModel
{
	...
	public static final AxisAlignedBB PLATE = new AxisAlignedBB(0.1875D, 0, 0.1875D, 0.8125D, 0.125D, 0.8125D);
	  ...
	  public boolean canPlaceBlockAt(World worldIn, BlockPos pos)
	    ...
	    {    
	        ...
	        {    
	            ...
	            InventoryHelper.spawnItemStack(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(BlockInit.PLATE_BLOCK, 1));
	        }      
	    }
