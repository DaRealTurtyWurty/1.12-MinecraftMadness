...
public class QuarryBlockBasicSilk extends Block implements IHasModel, ITileEntityProvider 
{
	public QuarryBlockBasicSilk(String name, Material material)
	{
		super(material);
	...
	{
		return new TileEntityQuarryBasicSilk();
	}
