...
public class EntityResistanceOrb extends EntitySnowball
{
    public EntityResistanceOrb(World worldIn)
    {
        super(worldIn);
    }

    public EntityResistanceOrb(World worldIn, EntityLivingBase throwerIn)
    {
        super(worldIn, throwerIn);
    }

    public EntityResistanceOrb(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
	/**
    ...
    protected void onImpact(RayTraceResult result, EntityPlayer player, EntityLivingBase entity)
    {
        if (result.entityHit != null)
        {
            ...
            {
            	entity.addPotionEffect(new PotionEffect(MobEffects.RESISTANCE, 1200, 2));
            }
