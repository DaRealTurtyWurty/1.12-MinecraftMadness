...
public class EntityFireResistanceOrb extends EntitySnowball
{
    public EntityFireResistanceOrb(World worldIn)
    {
        super(worldIn);
    }

    public EntityFireResistanceOrb(World worldIn, EntityLivingBase throwerIn)
    {
        super(worldIn, throwerIn);
    }

    public EntityFireResistanceOrb(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
	/**
    ...
    protected void onImpact(RayTraceResult result, EntityPlayer player, EntityLivingBase entity)
    {
        if (result.entityHit != null)
        {
            ...
            {
            	entity.addPotionEffect(new PotionEffect(MobEffects.FIRE_RESISTANCE, 1200, 2));
            }
