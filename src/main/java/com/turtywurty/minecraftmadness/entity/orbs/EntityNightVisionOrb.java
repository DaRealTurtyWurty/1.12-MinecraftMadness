...
public class EntityNightVisionOrb extends EntitySnowball
{
    public EntityNightVisionOrb(World worldIn)
    {
        super(worldIn);
    }

    public EntityNightVisionOrb(World worldIn, EntityLivingBase throwerIn)
    {
        super(worldIn, throwerIn);
    }

    public EntityNightVisionOrb(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
	/**
    ...
    protected void onImpact(RayTraceResult result, EntityPlayer player, EntityLivingBase entity)
    {
        if (result.entityHit != null)
        {
            ...
            {
            	entity.addPotionEffect(new PotionEffect(MobEffects.NIGHT_VISION, 1200, 2));
            }
