...
public class EntitySaturationOrb extends EntitySnowball
{
    public EntitySaturationOrb(World worldIn)
    {
        super(worldIn);
    }

    public EntitySaturationOrb(World worldIn, EntityLivingBase throwerIn)
    {
        super(worldIn, throwerIn);
    }

    public EntitySaturationOrb(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
	/**
    ...
    protected void onImpact(RayTraceResult result, EntityPlayer player, EntityLivingBase entity)
    {
        if (result.entityHit != null)
        {
            ...
            {
            	entity.addPotionEffect(new PotionEffect(MobEffects.SATURATION, 1200, 2));
            }
