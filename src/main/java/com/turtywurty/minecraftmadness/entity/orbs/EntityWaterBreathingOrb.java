...
public class EntityWaterBreathingOrb extends EntitySnowball
{
    public EntityWaterBreathingOrb(World worldIn)
    {
        super(worldIn);
    }

    public EntityWaterBreathingOrb(World worldIn, EntityLivingBase throwerIn)
    {
        super(worldIn, throwerIn);
    }

    public EntityWaterBreathingOrb(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
	/**
    ...
    protected void onImpact(RayTraceResult result, EntityPlayer player, EntityLivingBase entity)
    {
        if (result.entityHit != null)
        {
            ...
            {
            	entity.addPotionEffect(new PotionEffect(MobEffects.WATER_BREATHING, 1200, 2));
            }
