...
public class EntityHasteOrb extends EntityThrowable
{
    public EntityHasteOrb(World worldIn)
    {
        super(worldIn);
    }

    public EntityHasteOrb(World worldIn, EntityLivingBase throwerIn)
    {
        super(worldIn, throwerIn);
    }

    public EntityHasteOrb(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
	/**
    ...
    protected void onImpact(RayTraceResult result, EntityPlayer player, EntityLivingBase entity)
    {
        if (result.entityHit != null)
        {
            ...
            {
            	entity.addPotionEffect(new PotionEffect(MobEffects.HASTE, 1200, 2));
            }
