...
public class EntityLevitationOrb extends EntitySnowball
{
    public EntityLevitationOrb(World worldIn)
    {
        super(worldIn);
    }

    public EntityLevitationOrb(World worldIn, EntityLivingBase throwerIn)
    {
        super(worldIn, throwerIn);
    }

    public EntityLevitationOrb(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
	/**
    ...
    protected void onImpact(RayTraceResult result, EntityPlayer player, EntityLivingBase entity)
    {
        if (result.entityHit != null)
        {
            ...
            {
            	entity.addPotionEffect(new PotionEffect(MobEffects.LEVITATION, 1200, 2));
            }
