...
public class EntityStrengthOrb extends EntitySnowball
{
    public EntityStrengthOrb(World worldIn)
    {
        super(worldIn);
    }

    public EntityStrengthOrb(World worldIn, EntityLivingBase throwerIn)
    {
        super(worldIn, throwerIn);
    }

    public EntityStrengthOrb(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
	/**
    ...
    protected void onImpact(RayTraceResult result, EntityPlayer player, EntityLivingBase entity)
    {
        if (result.entityHit != null)
        {
            ...
            {
            	entity.addPotionEffect(new PotionEffect(MobEffects.STRENGTH, 1200, 2));
            }
