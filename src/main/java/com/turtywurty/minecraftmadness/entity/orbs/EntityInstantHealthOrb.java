...
public class EntityInstantHealthOrb extends EntitySnowball
{
    public EntityInstantHealthOrb(World worldIn)
    {
        super(worldIn);
    }

    public EntityInstantHealthOrb(World worldIn, EntityLivingBase throwerIn)
    {
        super(worldIn, throwerIn);
    }

    public EntityInstantHealthOrb(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
	/**
    ...
    protected void onImpact(RayTraceResult result, EntityPlayer player, EntityLivingBase entity)
    {
        if (result.entityHit != null)
        {
            ...
            {
            	entity.addPotionEffect(new PotionEffect(MobEffects.INSTANT_HEALTH, 1200, 2));
            }
