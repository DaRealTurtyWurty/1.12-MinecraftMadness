...
public class EntityRegenerationOrb extends EntitySnowball
{
    public EntityRegenerationOrb(World worldIn)
    {
        super(worldIn);
    }

    public EntityRegenerationOrb(World worldIn, EntityLivingBase throwerIn)
    {
        super(worldIn, throwerIn);
    }

    public EntityRegenerationOrb(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
	/**
    ...
    protected void onImpact(RayTraceResult result, EntityPlayer player, EntityLivingBase entity)
    {
        if (result.entityHit != null)
        {
            ...
            {
            	entity.addPotionEffect(new PotionEffect(MobEffects.REGENERATION, 1200, 2));
            }
